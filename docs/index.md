...
| [Design System](specs/design-system/)       | Target visual language — token contract, domain color discipline, card anatomy, size-adaptive layout tiers, typography, motion (not yet implemented)                                        | active |
