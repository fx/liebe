...
| [Design System](specs/design-system/)       | Target visual language — token contract, domain color discipline, card anatomy, size-adaptive layout tiers, typography, motion (token contract implemented; the rest pending)               | active |
