...
| [Design System](specs/design-system/)       | Visual language — token contract, domain color discipline, card anatomy, size-adaptive layout tiers, typography, motion (tokens, anatomy and card shell implemented; layout tiers pending 0011)                                                                      | active |
