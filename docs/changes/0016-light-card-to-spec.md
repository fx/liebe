...
- [ ] **PR 2b — Color and color-temperature controls**: the [color-temperature control](../specs/entity-cards/options/light.md#color-temperature-showcolortempcontrol) and the [colour control](../specs/entity-cards/options/light.md#color-showcolorcontrol); their config-form entries; payload/gating unit tests; stories
