...
- [ ] **PR 2b — Color and color-temperature controls**: warm→cool temperature control (entity-reported Kelvin range, never hardcoded); swatch-palette colour control with recent-colour slot; their config-form entries; payload/gating unit tests; stories
