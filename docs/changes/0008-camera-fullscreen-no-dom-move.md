...
- It is **Chromium 133+ only** (absent in Firefox, Safari, and jsdom) — every other browser would still fall back to detach+reattach and reconnect.
