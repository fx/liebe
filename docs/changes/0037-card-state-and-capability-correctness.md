...
- **The not-found treatment MUST be actionable.** A card whose entity is gone needs to say the entity is missing and that the card needs reconfiguring — the failure mode being fixed is a message that reads as progress.
