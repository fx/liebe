...
| `sliderPlacement` | select                                | `auto`   | Placement/orientation of the speed slider, per the [shared slider-placement contract](./common.md#shared-slider-placement-sliderplacement). Applies only under `speedControl: slider`; inert for `steps`/`none`. _Change [0034](../../../changes/0034-slider-placement.md), not yet implemented._                                                           |
