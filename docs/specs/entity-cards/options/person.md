...
- The identity colour is the **disc**, and the letters on it are not drawn in it. They are text, so they answer to 4.5:1, and the disc is a 20% tint of the very colour they would otherwise take — which measured 2.19–4.08:1 across the eight hues in both appearances until change [0035](../../../changes/0035-light-appearance-contrast.md) PR 4 split the two. The initials take the neutral foreground, by the live-hue rule in [design-system — domain color discipline](../../design-system/index.md#domain-color-discipline); the identity is carried by the disc, which is where a reader looks for it.
