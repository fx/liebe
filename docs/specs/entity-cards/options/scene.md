...
- Confirming MUST fire exactly one service call, followed by the normal activation feedback; cancelling (button, ESC, outside tap) MUST fire nothing and leave no pending state.
