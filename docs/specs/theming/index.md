...
All three are tracked by [0036](../../changes/0036-theming-contract-gaps.md), together with the 44px touch floor the layered baseline lost to unlayered vendor CSS — one change, because all four are the same shape: the base layer knows something a theme or a baseline rule needs and exposes it through a name that cannot be reached.
