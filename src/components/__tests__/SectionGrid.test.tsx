...
describe('SectionGrid', () => {
  ...
  it('should apply correct CSS classes for section widths', () => {
    ...
    const sections = screen.getAllByText(/Section \d/).map(el => 
      el.closest('.section-full, .section-half, .section-third, .section-quarter')
    );
  ...
  it('should make sections draggable in edit mode', () => {
    ...
    const draggableElements = screen.getAllByText(/Section \d/).map(el => 
