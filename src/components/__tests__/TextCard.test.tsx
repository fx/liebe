...
describe('TextCard', () => {
  ...
  it('should show markdown content in view mode', () => {
    render(<TextCard entityId="test-text-1" content="# Test Header" />)
  ...
  it('should show textarea in edit mode', () => {
    ...
    render(<TextCard entityId="test-text-1" content="Test content" onSelect={vi.fn()} />)
  ...
  it('should update content in real-time when typing in edit mode', () => {
    ...
    render(<TextCard entityId="test-text-1" content="Initial content" />)
    ...
    expect(mockUpdateGridItem).toHaveBeenCalledWith('test-screen', 'test-text-1', {
  ...
  it('should show delete button in edit mode', () => {
    ...
    render(<TextCard entityId="test-text-1" content="Test content" onDelete={onDelete} />)
